  ...
  <div v-if="Visible" class="detail">
    <div class="detail-view card">
      <div class="data card-body">
        <img class="image" :src="image+pokemonData.name+'.png'" >
        <h2 class="card-title">{{pokemonData.name}}</h2>
        <div class="property">Base Experience: {{pokemonData.base_experience}} XP</div>
        <div class="property">Height: {{pokemonData.height/10}} M</div>
        <div class="property">Weight: {{pokemonData.weight/10}} Kg</div>
        <h3>Types</h3>
        <div class="types">
          <div class="type" v-for="(pokemon, index) in pokemonData.types" :key="'pokemon'+index">
        ...
        <h3>Abilities</h3>
        <div class="abilities">
          <div class="ability" v-for="(pokemon, index) in pokemonData.abilities" :key="'pokemon'+index">
...
export default {
  ...
  methods:{
    closeDetail(){
      this.$emit('event_from_child2',this.pokemons)
    }
  },
